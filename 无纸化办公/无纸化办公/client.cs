...
namespace 无纸化办公
{
    public partial class client : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            //需要获取文本框中的IP地址
            IPAddress ipaddress = IPAddress.Parse(textBox3.Text.Trim());
            //将获取的ip地址和端口号绑定到网络节点endpoint上
            IPEndPoint endpoint = new IPEndPoint(ipaddress, int.Parse(textBox4.Text.Trim()));
        ...
        private void RecMsg()
        {
            while (true) //持续监听服务端发来的消息
            {
                ...
                //将发送的信息追加到聊天内容文本框中
                richTextBox1.AppendText("对方发送了:" + GetCurrentTime() + "\r\n" + strRecMsg + "\r\n");
            }
        }
        ...
        {
            ClientSendMsg(textBox1.Text.Trim(), 0);
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (ofDialog.ShowDialog(this) == DialogResult.OK)
            {
                ...
                textBox2.Text = fileName;      //将文件名显示在文本框上 
