...
namespace 无纸化办公
{
    public partial class server : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            IPAddress ipaddress = IPAddress.Parse(textBox2.Text.Trim()); //获取文本框输入的IP地址
            //将IP地址和端口号绑定到网络节点endpoint上 
            IPEndPoint endpoint = new IPEndPoint(ipaddress, int.Parse(textBox3.Text.Trim())); //获取文本框上输入的端口号
            //监听绑定的网络节点
            try
            {
            ...
            {
                richTextBox1.AppendText("系统异常消息:" + ex.Message);
        ...
        private void WatchConnecting()
        {
            while (true)  //持续不断监听客户端发来的请求
            {
                ...
                richTextBox1.AppendText("客户端连接成功" + "\r\n");
                //创建一个通信线程 
        ...
        private void ServerSendMsg(string sendMsg)
        {
            ...
            richTextBox1.AppendText("我发送了:" + GetCurrentTime() + "\r\n" + sendMsg + "\r\n");
        }
                    ...
                    if (firstReceived > 0) //接受到的长度大于0 说明有信息或文件传来
                    {
                        if (buffer[0] == '$') //0为文字信息
                        {
                            ...
                            while (cmd.CmdQueue.Count != 0)
                            {
                                ...
                                richTextBox1.AppendText("对方发送了:" + strCmd + "\n");
                            }
                        }
                        ...
                        if (buffer[0] == 1)//1为文件
                        {
                            ...
                            if (sfDialog.ShowDialog(this) == DialogResult.OK)
                            {
                                ...
                                richTextBox1.AppendText("对方:" + GetCurrentTime() + "\r\n您成功接收了文件" + fName + "\r\n保存路径为:" + fPath + "\r\n");
                            }
                        }
                    }
                }
        ...
        private void txtSendMsg_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                //则调用 服务器向客户端发送信息的方法
                ServerSendMsg(textBox1.Text.Trim());
            }
        }
